...
import 'components/criteria_record.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Padding(
                              padding:
                                  EdgeInsets.only(left: 8.0, right: 3, top: 2),
                              child: Divider(),
                            ),
                            Padding(
                                  ...
                                  child:Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Image.asset("assets/images/height.png",fit: BoxFit.cover,),
                                      ),
                                      Column(
                                  ...
                                  child:Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        width: 40,
                                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(12), color: Colors.white),
                                        child: Image.asset("assets/images/age.png",fit: BoxFit.cover,),
                                      ),
                                      Column(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        crossAxisAlignment:  CrossAxisAlignment.start,
      ...
      floatingActionButton: FloatingActionButton.extended(onPressed: (){
        ...
        DatabaseApis.updateReceipentDetails(_age, _blood, _weight,_height, _health_details, context);
